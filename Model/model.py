...
class AutoEncoder(torch.nn.Module):
    def __init__(self, args):
        ...
        self.temporal_encoder = Temporal_Encoder(dscale=[2,2,2,1], channels=[64,32,32], temporal_kernel_size=[2,2,2,3])
        self.temporal_decoder = Temporal_Decoder(uscale=[2,2,2,1], channels=[32,32,64], temporal_kernel_size=[2,2,2,3])
